...
Shader "PolyToots/Flipbook_MotionVector"
{
	Properties
	{
		_RowsColumnsXY("Rows Columns XY", Vector) = (8,8,0,0)
		...
		[HDR]_Fire("Fire", Color) = (76.15007,76.15007,76.15007,0)
	...
	LOD 0
		...
		Pass
		{
			...
			uniform float4 _Fire;
			uniform sampler2D _MainTex;
			uniform float2 _RowsColumnsXY;
				...
				) : SV_Target 
			{
				...
				float temp_output_35_0_g3 = frac( ( ( IN.ase_texcoord9.xyz.z + clampResult42_g3 ) / totalFrames39_g3 ) );
				float2 appendResult29_g3 = (float2(temp_output_35_0_g3 , ( 1.0 - temp_output_35_0_g3 )));
				float2 temp_output_15_0_g3 = ( ( IN.ase_texcoord9.xyz.xy / appendResult7_g3 ) + ( floor( ( appendResult8_g3 * appendResult29_g3 ) ) / appendResult7_g3 ) );
				float2 temp_output_10_0 = temp_output_15_0_g3;
				float2 temp_cast_0 = (1.0).xx;
				float temp_output_36_0 = frac( IN.ase_texcoord9.xyz.z );
				...
				float temp_output_35_0_g2 = frac( ( ( ( IN.ase_texcoord9.xyz.z + 1.0 ) + clampResult42_g2 ) / totalFrames39_g2 ) );
				float2 appendResult29_g2 = (float2(temp_output_35_0_g2 , ( 1.0 - temp_output_35_0_g2 )));
				float2 temp_output_15_0_g2 = ( ( IN.ase_texcoord9.xyz.xy / appendResult7_g2 ) + ( floor( ( appendResult8_g2 * appendResult29_g2 ) ) / appendResult7_g2 ) );
				...
				o.Albedo = ( lerpResult50 * lerpResult46 ).rgb;
				...
				o.Smoothness = 0;
				o.Occlusion = 1;
				o.Alpha = ( lerpResult49 * IN.ase_color.a );
		...
		Pass
		{
			...
			) 
			{
				...
				float2 appendResult8_g3 = (float2(totalFrames39_g3 , temp_output_5_0_g3));
				float clampResult42_g3 = clamp( 0.0 , 0.0001 , ( totalFrames39_g3 - 1.0 ) );
				float temp_output_35_0_g3 = frac( ( ( IN.ase_texcoord8.xyz.z + clampResult42_g3 ) / totalFrames39_g3 ) );
				float2 appendResult29_g3 = (float2(temp_output_35_0_g3 , ( 1.0 - temp_output_35_0_g3 )));
				float2 temp_output_15_0_g3 = ( ( IN.ase_texcoord8.xyz.xy / appendResult7_g3 ) + ( floor( ( appendResult8_g3 * appendResult29_g3 ) ) / appendResult7_g3 ) );
				float2 temp_output_10_0 = temp_output_15_0_g3;
				float2 temp_cast_0 = (1.0).xx;
				float temp_output_36_0 = frac( IN.ase_texcoord8.xyz.z );
				float4 tex2DNode12 = tex2D( _MainTex, ( temp_output_10_0 - ( ( ( ( (tex2D( _MotionVector, temp_output_10_0 )).rg * 2.0 ) - temp_cast_0 ) * temp_output_36_0 ) * _Influence ) ) );
				float temp_output_4_0_g2 = _RowsColumnsXY.x;
				float temp_output_5_0_g2 = _RowsColumnsXY.y;
				float2 appendResult7_g2 = (float2(temp_output_4_0_g2 , temp_output_5_0_g2));
				...
				float2 appendResult8_g2 = (float2(totalFrames39_g2 , temp_output_5_0_g2));
				float clampResult42_g2 = clamp( 0.0 , 0.0001 , ( totalFrames39_g2 - 1.0 ) );
				float temp_output_35_0_g2 = frac( ( ( ( IN.ase_texcoord8.xyz.z + 1.0 ) + clampResult42_g2 ) / totalFrames39_g2 ) );
				float2 appendResult29_g2 = (float2(temp_output_35_0_g2 , ( 1.0 - temp_output_35_0_g2 )));
				float2 temp_output_15_0_g2 = ( ( IN.ase_texcoord8.xyz.xy / appendResult7_g2 ) + ( floor( ( appendResult8_g2 * appendResult29_g2 ) ) / appendResult7_g2 ) );
				float2 temp_output_16_0 = temp_output_15_0_g2;
				float2 temp_cast_1 = (1.0).xx;
				float4 tex2DNode42 = tex2D( _MainTex, ( ( ( ( ( (tex2D( _MotionVector, temp_output_16_0 )).rg * 2.0 ) - temp_cast_1 ) * ( 1.0 - temp_output_36_0 ) ) * _Influence ) + temp_output_16_0 ) );
				float4 lerpResult46 = lerp( tex2DNode12 , tex2DNode42 , temp_output_36_0);
...
/*ASEBEGIN
Version=18935
448;73;1016;396;664.5738;468.1906;1.88176;True;False
...
Node;AmplifyShaderEditor.PowerNode;55;-204.7511,-448.6257;Inherit;False;True;2;0;FLOAT;0;False;1;FLOAT;3.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;50;-42.74032,-778.6758;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=69CB3B3BF3F26FCA077C1F91EBC800AC51ADEF9A